-- Create transfers table to track blood transfers from donations to recipients
...
CREATE INDEX IX_transfers_hospital_id ON transfers(hospital_id);
CREATE INDEX IX_transfers_request_id ON transfers(request_id);
CREATE INDEX IX_transfers_blood_type ON transfers(blood_type);
